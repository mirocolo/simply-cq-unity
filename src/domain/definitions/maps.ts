...
export const MAP_DEFINITIONS: Record<string, MapDefinition> = {
  'map_biqi_0': {
    ...
    spawns: [
      { templateId: 'm_scarecrow', count: 6, center: { x: 12, y: 12 }, radius: 6, respawnTicks: 120 },
      { templateId: 'm_cat', count: 6, center: { x: 24, y: 12 }, radius: 6, respawnTicks: 140 },
      { templateId: 'm_spider', count: 5, center: { x: 12, y: 24 }, radius: 6, respawnTicks: 160 },
      { templateId: 'm_skeleton', count: 5, center: { x: 24, y: 24 }, radius: 6, respawnTicks: 180 },
      { templateId: 'm_zombie', count: 1, center: { x: 28, y: 28 }, radius: 4, respawnTicks: 240, isGuaranteedBoss: true }
    ]
  },
  ...
  'map_wooma_1': {
    ...
    spawns: [
      { templateId: 'm_skeleton', count: 6, center: { x: 12, y: 18 }, radius: 5, respawnTicks: 150 },
      { templateId: 'm_zombie', count: 6, center: { x: 18, y: 12 }, radius: 5, respawnTicks: 160 },
      { templateId: 'm_white_pig', count: 2, center: { x: 20, y: 24 }, radius: 4, respawnTicks: 180 },
      { templateId: 'm_wooma_boss', count: 1, center: { x: 28, y: 18 }, radius: 3, respawnTicks: 240, isGuaranteedBoss: true }
    ]
  },
  ...
  'map_zuma_2': {
    ...
    spawns: [
      { templateId: 'm_zuma_statue', count: 8, center: { x: 16, y: 18 }, radius: 6, respawnTicks: 160 },
      { templateId: 'm_white_pig', count: 3, center: { x: 22, y: 12 }, radius: 5, respawnTicks: 180 },
      { templateId: 'm_zuma_boss', count: 1, center: { x: 28, y: 18 }, radius: 3, respawnTicks: 250, isGuaranteedBoss: true }
    ]
  },
  ...
  'map_redmoon_3': {
    ...
    spawns: [
      { templateId: 'm_zuma_statue', count: 6, center: { x: 14, y: 18 }, radius: 5, respawnTicks: 160 },
      { templateId: 'm_white_pig', count: 4, center: { x: 20, y: 12 }, radius: 5, respawnTicks: 180 },
      { templateId: 'm_red_moon', count: 1, center: { x: 28, y: 18 }, radius: 3, respawnTicks: 260, isGuaranteedBoss: true }
    ]
  },
  ...
  'map_cangyue_4': {
    ...
    spawns: [
      { templateId: 'm_cangyue_skeleton', count: 8, center: { x: 16, y: 18 }, radius: 6, respawnTicks: 160 },
      { templateId: 'm_huangquan_boss', count: 1, center: { x: 28, y: 18 }, radius: 3, respawnTicks: 260, isGuaranteedBoss: true }
    ]
  },
  ...
  'map_molong_5': {
    ...
    spawns: [
      { templateId: 'm_molong_blade', count: 8, center: { x: 16, y: 18 }, radius: 6, respawnTicks: 160 },
      { templateId: 'm_molong_boss', count: 1, center: { x: 28, y: 18 }, radius: 3, respawnTicks: 280, isGuaranteedBoss: true }
    ]
  },
  ...
  'map_niumo_6': {
    ...
    spawns: [
      { templateId: 'm_niumo_general', count: 8, center: { x: 16, y: 18 }, radius: 6, respawnTicks: 170 },
      { templateId: 'm_niumo_boss', count: 1, center: { x: 28, y: 18 }, radius: 3, respawnTicks: 280, isGuaranteedBoss: true }
    ]
  },
  ...
  'map_huolong_7': {
    ...
    spawns: [
      { templateId: 'm_huolong_beast', count: 8, center: { x: 16, y: 18 }, radius: 6, respawnTicks: 170 },
      { templateId: 'm_huolong_boss', count: 1, center: { x: 28, y: 18 }, radius: 3, respawnTicks: 300, isGuaranteedBoss: true }
    ]
  },
  ...
  'map_shura_8': {
    ...
    spawns: [
      { templateId: 'm_shura_warrior', count: 8, center: { x: 16, y: 18 }, radius: 6, respawnTicks: 180 },
      { templateId: 'm_shura_boss', count: 1, center: { x: 28, y: 18 }, radius: 3, respawnTicks: 320, isGuaranteedBoss: true }
    ]
  },
  ...
  'map_void_9': {
    ...
    spawns: [
      { templateId: 'm_void_beast', count: 10, center: { x: 16, y: 18 }, radius: 6, respawnTicks: 180 },
      { templateId: 'm_void_boss', count: 1, center: { x: 28, y: 18 }, radius: 3, respawnTicks: 360, isGuaranteedBoss: true }
    ]
  }
};
