...
namespace SimplyCQ.Domain
{
    ...
    public sealed class Simulation
    {
        ...
        public Simulation(GameMap map, uint seed, Func<string, Entity> monsterFactory,
                          ...
                          IMapCatalog maps = null, LootTuning loot = null)
        {
            Bus = new EventBus();
            ...
            LootTuning lootTuning = loot != null ? loot : new LootTuning();
            lootTuning.Clamp();
            ...
            World.Systems.Add(new DeathSystem(Tuning, Catalog, lootTuning));
